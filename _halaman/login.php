    ...
    if(isset($_POST['login'])){
        ...
        if($db->count>0){
          ...
          $session->set("info",'<div class="alert alert-success alert-dismissible">
                    ...
                    <h4><i class="icon fa fa-ban"></i> Success!</h4> Welcome to WebGIS Wisata <b>'.$data->nm_pengguna.'</b>
                  </div>');
          ...
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <h4><i class="icon fa fa-ban"></i> Error!</h4> Username or Password Wrong
        </div>');
        redirect(url("login"));
        }
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Login</b>WebgisWisata</a>
  </div>
  <!-- /.login-logo -->
